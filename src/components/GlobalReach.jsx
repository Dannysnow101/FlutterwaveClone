...
const GlobalDivRight= () => {
    return (
      ...
      <div className="xl:size-[40rem] size-[30rem] flex relative">
        
      <section className='bg-globeBlue relative xl:size-[40rem] size-[30rem] flex items-start justify-start rounded-[50%] overflow-hidden '>     
  ...
  const GlobalDivLeft= () => {
    return (
      <article className='flex xl:gap-8 gap-6 w-[40%] h-20rem items-start'> 

<div className="h-[26rem] md:flex md:flex-col bg-primaryPink hidden">
...
<div className="flex flex-col xl:gap-6 gap-2 ">
    <h5 className='font-semibold md:text-xl text-lg text-primaryGreen' >30+ Currencies</h5>
...
<div className="flex flex-col xl:gap-6 gap-2 ">
    <h5 className='font-semibold md:text-xl text-lg' >20M+ API calls</h5>
<p className='font-normal text-lg'> API calls per day peaking at 231 requests per seccond</p>
</div>


<div className="flex flex-col xl:gap-6 gap-2 ">
    <h5 className='font-semibold md:text-xl text-lg'>500k+ Payments daily</h5>
<p className='font-normal text-lg'>Average number of payments processed daily</p>
</div>


<div className="flex flex-col xl:gap-6 gap-2 ">
    <h5 className='font-semibold md:text-xl text-lg'>15+ Payment Options</h5>
...
const GlobalReach = () => {
  return (
    <section className='w-full  flex gap-[6rem] justify-between flex-wrap items-center pt-[8rem] flex-col'>
<h4 className="md:text-6xl text-4xl  font-millik">
...
<div className="flex w-full overflow-hidden gap-[6rem] md:justify-between items-center flex-wrap p-4">
